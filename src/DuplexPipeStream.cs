...
// copied from https://github.com/dotnet/aspnetcore/blob/a450cb69b5e4549f5515cdb057a68771f56cefd7/src/Shared/ServerInfrastructure/DuplexPipeStream.cs
...
internal class DuplexPipeStream : Stream
{
    ...
    protected DuplexPipeStream(PipeReader input, PipeWriter output, bool throwOnCancelled = false)
    {
        _input = input;
        _output = output;
